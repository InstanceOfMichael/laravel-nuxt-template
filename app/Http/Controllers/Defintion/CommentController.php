...
class CommentController extends Controller
{
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(StoreComment $request, Definition $definition)
    {
        return $definition->comments()
            ->create([
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(Definition $definition, Comment $comment)
    {
        return [
            'comment' => $comment,
        ];
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(UpdateComment $request, Definition $definition, Comment $comment)
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroy(Definition $definition, Comment $comment)
    {
